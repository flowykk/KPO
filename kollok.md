...
Unified Modeling Language (UML) предоставляет различные типы диаграмм, каждая из которых служит определенной цели и предназначена для моделирования конкретных аспектов системы. Вот основные типы диаграмм в UML:

#### Диаграмма классов (Class Diagram):

_Цель:_ Моделирование структуры системы, её классов, атрибутов и методов.
_Применение:_ Используется для визуализации структуры классов, их атрибутов, методов и отношений между классами.

#### Диаграмма вариантов использования (Use Case Diagram):

_Цель:_ Описывает функциональность системы с точки зрения внешних акторов.
_Применение:_ Используется для идентификации основных сценариев использования системы и взаимодействия с внешними акторами.

#### Диаграмма последовательности (Sequence Diagram):

_Цель:_ Показывает взаимодействие объектов во времени, обозначая порядок вызовов методов.
_Применение:_ Используется для моделирования динамического поведения системы, особенно взаимодействия между объектами.
...
#### Абстрагирование
Отделение способа использования объекта от способа его внутренней
реализации. Достичь этого можно с помощью введения интерфейсов, описывающих возможные способы использования структуры данных
```kt
// Пример абстракции через интерфейс
interface Shape {
    fun draw()
}
...
#### Наследование 
Возможность экземпляров класса содержать в себе (наследовать)
реализацию другого класса, включающую данные и методы. Класс-наследник уточняет определение базового класса, добавляя свои
характеристики. Класс-наследник «конкретнее» базового класса.
```kt
// Пример наследования
...
_Ad hoc (по случаю) полиморфизм:_
...
_Параметрический полиморфизм:_
...
_Полиморфизм включения (subtyping):_
Программа, реализованная для работы с супер-типом, может также работать с суб-типом (наследником).Например, принцип подстановки Барбары Лисков.
```kotlin
open class Shape {
    open fun draw() {
